...
namespace CafeShopManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\User\OneDrive\Documents\cafe.mdf;Integrated Security=True;Connect Timeout=30"); public AdminAddUsers()
        {
            InitializeComponent();
                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkUsern = new SqlCommand(selectUsern, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\User\source\repos\CafeShopManagementSystem\CafeShopManagementSystem\User_Directory\" 
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MessageBox.Show("No Image D:", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
