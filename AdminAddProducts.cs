                    ...
                    if(connect.State != ConnectionState.Open)
                    {
                        try
                        {
                            ...
                            using(SqlCommand updateD = new SqlCommand(updateData, connect))
                            {
                                ...
                                MessageBox.Show("Update sucessfully!", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                displayData();
                            }
                        }catch(Exception ex)
                        {
                    ...
                    if (connect.State != ConnectionState.Open)
                    {
                        try
                        {
                            ...
                            using (SqlCommand updateD = new SqlCommand(updateData, connect))
                            {
                                ...
                                MessageBox.Show("Removed sucessfully!", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                displayData();
                            }
                        }
                        catch (Exception ex)
